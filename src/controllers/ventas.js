...
const httpVenta = {
    ...
    // Insertar una nueva venta
     crear: async (req, res) => {
         const { idcliente, fecha, ValorTotalVenta } = req.body;
        try {
            // Crea una nueva instancia de Venta con los datos proporcionados
            const venta = new Venta({ idcliente, fecha, ValorTotalVenta });
